...
randomCoord xBound yBound = Random.map2 (,) (Random.int 0 (xBound - 1)) (Random.int 0 (yBound - 1))
...
eatFood food snake = if intersects food (snakeHead snake) then snake else List.drop 1 snake
